...
namespace Veterinaria.Application.Service
{
    public class AuthService : IAuthService
    {
        ...
        // Valida si una operación de Identity fue exitosa, en caso de falla:
        ...
        public async Task<RespuestaLoginDto> LoginAsync(UsuarioLoginDto dto)
        {
            ...
            await _refresRepo.GuardarAsycn(refreshEntity);
        ...
        {
            var tokenDB = await _refresRepo.ObtenerAsycn(refreshToken);
